# AI Agent Guidelines for ownCloud Media Viewer
...
- **Build system:** Make + Webpack + Yarn
...
- `src/` -- Webpack/JavaScript source files
- `templates/` -- PHP templates
- `l10n/` -- Translations
- `webpack.config.js` -- Webpack configuration
- `package.json` -- Yarn/npm scripts
...
```bash
# Build
make dist  # or: yarn install && yarn build
